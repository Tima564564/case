...
export default function Home() {
  ...
  function createTonDeposit() {
    if (!tonConnected) {
      void tonConnectUI.openModal();
      return;
    }
    setToast("TON deposit invoice prepared");
  }
